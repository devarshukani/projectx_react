...
const RequestQAE = ({ setQae, setEmailSent }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      {/* Main container with max-width to ensure consistent size */}
      <div className="relative w-full max-w-[537px] mx-auto bg-white rounded-xl p-5 m-4">
        ...
        <div className="w-full max-w-[465px] px-4 py-2 rounded-md outline-2 mt-3 outline-offset-[-1px] outline-zinc-800 inline-flex justify-between items-center">
          <input
            type="email"
