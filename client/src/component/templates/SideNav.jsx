...
const SideNav = () => {
  return (
    <div className="w-24 flex flex-col justify-center items-center bg-[#ffffff]">
      ...
      <div className=" flex flex-col items-center gap-12">
        <Link to="/">
          <img className="h-[4.5vh]" src={home} alt="" />
        </Link>
        <Link to="/video">
          <img className="h-[3.8vh]" src={play} alt="" />
        </Link>
        <Link>
          <img className="h-[4.5vh]" src={question} alt="" />
        </Link>
        <Link to="/test">
        ...
        <Link>
          <img className="h-[4vh]" src={setting} alt="" />
        </Link>
      </div>
    </div>
  );
